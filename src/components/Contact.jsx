          ...
          <div className="md:w-1/2 mt-12 md:ml-24 md:mt-24 order-2">
            <div className="flex flex-col md:flex-row justify-between space-y-4 md:space-y-0">
              ...
              <div className="flex flex-col items-center md:items-start space-y-2">
                <h1 className="text-center md:text-left text-blue-900">Mobile No.</h1>
                <div className="text-center md:text-left bg-blue-100 rounded shadow-md">+91-8208448509</div>
              </div>
              {/* Right column */}
              <div className="flex flex-col items-center md:items-end space-y-2">
                <h1 className="text-center justify-between md:text-right text-blue-900">Email</h1>
                <div className="text-center md:text-right bg-blue-100 rounded shadow-md">creativetechskillshr@gmail.com</div>
              </div>
            </div>
          </div>
        </div>
